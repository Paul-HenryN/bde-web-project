...
const { createEvent, getEventsById, updateEvent, deleteEvent } = require('./controllers/eventcontroller');
const { createArticle, getArticlesById, updateArticle, deleteArticle } = require('./controllers/articlecontroller');
const { createCategory, getCategoriesById, updateCategory, deleteCategory } = require('./controllers/categorycontroller');
...
//It's through this myRouter object we implement the different http methods. 
var myRouter = express.Router(); 

//Route dedicated to the login of other websites designers
...
// myRouter.get('/events/location/:location', checkToken, getEventByLocation);
